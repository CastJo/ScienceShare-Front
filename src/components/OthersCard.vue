<template>
    <div class="wrap">
        ...
        <div class="self-info">
            <div>
                <span><h1>{{ this.user.username }}</h1></span>
                <span><h5>{{ this.user.college }}</h5></span>
                <a v-if="this.user.identity===2" @click="goExpertPage" style="cursor: pointer">他的专家主页></a>
            </div>
            <div class="emailEnTime">
                <span><h6>邮箱: {{ this.user.emailAddress }}</h6></span>
        ...
        <div style="width: 65%;height: 200px">
            <el-button v-if="this.isFollowing === 0" class="followButtom" type="primary" @click="follow">+Follow
            </el-button>
